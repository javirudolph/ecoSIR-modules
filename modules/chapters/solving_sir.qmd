...
We will go over each method separately in [Sections @sec-euler-method] and [@sec-pracma] and the differences between the two in [Section @sec-evaluating-and-comparing-both-methods].
