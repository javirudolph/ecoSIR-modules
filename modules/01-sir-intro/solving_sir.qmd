---
title: "Numerical Methods for Solving SIR Models"
engine: knitr
webr:
  packages:
    - pracma
...
$$
\begin{aligned}
s_{t+1} &= s_t - \Delta t \ \big( \beta \big) 
\left( \frac{i_t}{N} \right) \big( s_t \big) \\[10pt]
...
::: {.callout-note title="The loop is the model"}
